...
class BlogController extends AbstractController
{
    ...
    public function publicationNew(Request $request, ManagerRegistry $doctrine): Response
    {
        ...
        if($form->isSubmitted() && $form->isValid()){
            ...
            // Redirige sur la page qui affiche le nouvel article
    ...
    /**
     * Contrôleur de la page qui affiche un article en détail
     */
    ...
    /**
     * Contrôleur de la page admin servant à modifier un article via son id passé dans l'URL
     *
     * Accès réservé aux administrateurs (ROLE_ADMIN)
     */
